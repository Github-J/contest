...
- (void)viewDidLoad
{
    ...
    NSURLRequest *req = [NSURLRequest requestWithURL:[NSURL URLWithString:@"http://www49.atpages.jp/poritan6479/html/photo.php"]];
    [photo loadRequest:req];
...
- (void)webViewDidStartLoad:(UIWebView*)webView{
   ...
   [SVProgressHUD showWithStatus:@"ロード中です…。" maskType:SVProgressHUDMaskTypeGradient];
    NSString *bgmPath = [[NSBundle mainBundle]
                         pathForResource:@"Photofream" ofType:@"mp3"];
